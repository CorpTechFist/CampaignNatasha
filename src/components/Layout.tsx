...
export function Layout({ children }: LayoutProps) {
  ...
  const scrollToGetInvolved = () => {
    if (location.pathname === '/') {
      const section = document.querySelector('#get-involved');
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#F8F9FA' }}>
                ...
                <Link
                  ...
                  onMouseLeave={(e) =>
                    (e.currentTarget.style.color =
                      location.pathname === item.href ? '#6B2E8C' : '#374151')
                  }
                >
                  {item.name}
                </Link>
      ...
      {/* Footer */}
      <footer
        style={{ backgroundColor: '#E3D1EC' }}
        className="text-gray-900 py-12 border-t border-purple-200"
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-700">
                <li>
                  <Link to="/volunteer" className="hover:text-purple-800">
                    Volunteer
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link to="/news" className="hover:text-purple-800">
                    Events
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-700">
                <li>
                  <a
                    href="https://www.facebook.com/profile.php?id=61577783504235"
                    target="_blank"
                ...
                <li>
                  <a
                    href="https://www.instagram.com/natassja.grossman.4utah?igsh=d3I1MDQ3aW83YWhz"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="hover:text-purple-800"
                  >
                ...
                <li>
                  <a href="tel:+18018767082" className="hover:text-purple-800">
                    (801) 876-7082
                  </a>
                </li>
              </ul>
