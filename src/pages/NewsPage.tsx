  ...
  return (
    <>
      ...
      >
        ...
        >
          <div
            className="relative px-6 sm:px-8 lg:px-16 xl:px-24 max-w-3xl"
            style={{ zIndex: 2 }}
          >
            <div className="space-y-6 text-white">
              <h1 className="lg:text-6xl leading-tight text-[96px]">News</h1>
            </div>
          </div>
          ...
          <div className="mt-16 text-center">
            <Card className="p-8" style={{ backgroundColor: '#6B2E8C' }}>
              ...
              <p className="text-purple-100 mb-6 max-w-2xl mx-auto">
                Get the latest campaign updates, event invitations, and news
