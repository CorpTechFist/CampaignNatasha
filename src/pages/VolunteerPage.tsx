...
{/* Impact Stats */}
        <div className="grid md:grid-cols-4 gap-6 mb-16">
          ...
          <Card className="p-6 text-center">
            <div className="text-3xl mb-2" style={{color: '#6B2E8C'}}>12,000+</div>
            <div className="text-gray-600">Doors Knocked</div>
          </Card>
          <Card className="p-6 text-center">
            <div className="text-3xl mb-2" style={{color: '#6B2E8C'}}>8,500+</div>
                ...
                <div className="p-8">
                  <div className="flex items-start gap-6">
                    <div className="flex-shrink-0">
                      <role.icon className="h-12 w-12" style={{color: role.color}} />
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center gap-4 mb-4">
                        <h4 className="text-2xl text-gray-900">{role.title}</h4>
                        <Badge className="text-white" style={{backgroundColor: role.color}}>
                          High Impact
                        </Badge>
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                          ...
                          <ul className="space-y-2">
                            {role.tasks.map((task, index) => (
                              <li key={index} className="flex items-start gap-3">
                                <div className="w-2 h-2 rounded-full mt-2 flex-shrink-0" style={{backgroundColor: role.color}} />
                        ...
                        <div className="flex items-end">
                          <Button 
                            ...
                            onClick={() =>
                              navigate("/contact", { state: { source: `Volunteer Page - Sign up for ${role.title}` } })
                            }
                          >
          ...
          <Card className="p-8" style={{backgroundColor: '#4A1A5C'}}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                ...
                onClick={() =>
                  navigate("/contact", { state: { source: "Volunteer Page - Sign up to volunteer" } })
                }
              >
              ...
              <Button 
                size="lg"
                variant="outline"
                className="border-white text-purple-900"
                onClick={() =>
                  navigate("/contact", { state: { source: "Volunteer Page - Contact Volunteer Coordinator" } })
                }
              >
