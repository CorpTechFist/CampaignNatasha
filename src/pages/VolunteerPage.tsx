  ...
  const volunteerRoles = [
    {
      ...
      description:
        "Connect with voters by phone to share Natassja's message and identify supporters.",
      tasks: [
    ...
    },
    {
      ...
      description:
        "Go door-to-door in neighborhoods to talk with voters about Natassja's campaign.",
      tasks: [
    ...
    },
    {
      ...
      description:
        "Help plan and execute campaign events, from house parties to community forums.",
      tasks: [
    ...
    },
    {
      ...
      description:
        "Spread our message on social media and help with digital outreach efforts.",
      tasks: [
    ...
    },
    {
      ...
      description:
        "Help connect the campaign with community organizations and local groups.",
      tasks: [
    ...
    },
    {
      ...
      timeCommitment: "2-4 hours/week",
      description:
        "Provide essential behind-the-scenes support to keep the campaign running smoothly.",
      tasks: [
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Grassroots movements are built by people like you. Whether you
              have 2 hours or 20 hours a week, there's a meaningful way for you
              to help build a better Utah.
            </p>
          </div>
                    ...
                    <div className="flex items-start gap-6">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                          <div>
                            <h5 className="text-lg mb-3 text-gray-900">
                              What You'll Do:
                            </h5>
                          ...
                          <div className="flex items-end">
                            <Button
                              ...
                              onClick={() =>
                                navigate("/contact", {
                                  state: {
                                    source: `Volunteer Page - ${role.title}`,
                                  },
                                })
                              }
                            >
          ...
          <div className="text-center py-20 px-4 bg-purple-50">
            <Card className="p-8" style={{ backgroundColor: '#4A1A5C' }}>
              ...
              <p className="text-purple-100 mb-6 max-w-2xl mx-auto">
                Join hundreds of volunteers who are working to build a more
                equitable Utah. Fill out our volunteer form and we'll connect
                you with opportunities that match your interests and schedule.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button
                  size="lg"
                  className="text-purple-900 bg-white hover:bg-gray-100"
                  onClick={() =>
                    navigate("/contact", {
                      state: {
                        source: "Volunteer Page - Sign up to Volunteer",
                      },
                    })
                  }
                >
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="border-white text-purple-900 transition-colors"
                  onMouseEnter={(e) => {
                  ...
                  onClick={() =>
                    navigate("/contact", {
                      state: { source: "Volunteer Page -  Contact Volunteer Coordinator" },
                    })
                  }
                >
